"""
Django settings for biodev project.
...
SECRET_KEY = '7r)-5b=w1nzc(%p=(+fyvnzwosvmj4+=f7ci87e@2enuh)xat0'
...
WSGI_APPLICATION = 'biodev.wsgi.application'
